...
const ExplicationModel = ({ question, setShowExplanation }) => {
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="p-4 bg-white border border-gray-200 rounded-2xl shadow-sm max-w-2xl w-full max-h-[60vh] overflow-y-auto relative">
        <X onClick={() => setShowExplanation(false)} className="cursor-pointer absolute top-4 right-4 text-gray-400 hover:text-gray-700 transition-colors" />
