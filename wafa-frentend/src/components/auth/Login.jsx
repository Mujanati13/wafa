          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-sm text-blue-600 hover:text-blue-500 transition-colors duration-300">
                  Mot de passe oublié?
                </Link>
              </div>
            ...
            <div className="text-center mt-8">
              <p className="text-gray-600">
                ...
                <Link to="/register" className="text-blue-600 hover:text-blue-500 font-medium transition-colors duration-300">
                  S'inscrire
                </Link>
              </p>
            </div>
